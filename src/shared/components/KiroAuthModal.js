    ...
    <Modal isOpen={isOpen} title="Connect Kiro" onClose={onClose} size="lg">
      <div className="flex flex-col gap-4">
        ...
        {!selectedMethod && (
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full p-4 text-left border border-border rounded-none hover:bg-sidebar transition-colors"
            >
            ...
            <button
              ...
              className="hidden w-full p-4 text-left border border-border rounded-none hover:bg-sidebar transition-colors"
            >
              <div className="flex items-start gap-3">
        ...
        {selectedMethod === "api-key" && (
          <div className="space-y-4">
            <div className="bg-blue-50 dark:bg-blue-900/20 p-3 rounded-none border border-blue-200 dark:border-blue-800">
              <div className="flex gap-2">
            ...
            {error && (
              <div className="bg-red-50 dark:bg-red-900/20 p-3 rounded-none border border-red-200 dark:border-red-800">
        ...
        {selectedMethod === "social-google" && (
          <div className="space-y-4">
            <div className="bg-amber-50 dark:bg-amber-900/20 p-4 rounded-none border border-amber-200 dark:border-amber-800">
              <div className="flex gap-2">
          ...
          <div className="space-y-4">
            ...
            {!autoDetecting && (
              <>
                ...
                {autoDetected && (
                  <div className="bg-green-50 dark:bg-green-900/20 p-3 rounded-none border border-green-200 dark:border-green-800">
                    <div className="flex gap-2">
