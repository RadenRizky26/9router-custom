      ...
      <div className="flex flex-col gap-4">
        ...
        {!autoDetecting && (
          <>
            ...
            {windowsManual && (
              <div className="bg-amber-50 dark:bg-amber-900/20 p-3 rounded-none border border-amber-200 dark:border-amber-800 flex flex-col gap-2">
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full px-3 py-2 text-sm font-mono border border-border rounded-none bg-background focus:outline-none focus:border-primary resize-none"
              />
            </div>
