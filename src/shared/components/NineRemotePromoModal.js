...
export default function NineRemotePromoModal({ isOpen, onClose }) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-sm rounded-none overflow-hidden shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] fade-in flex flex-col bg-surface border border-border-subtle">
        {/* Header */}
        <div className="flex items-center justify-between px-5 py-3 border-b border-border-subtle">
          <div className="flex items-center gap-3">
            <div className="w-7 h-7 rounded-none flex items-center justify-center bg-primary">
        ...
        <div className="px-7 py-7 pb-9 flex flex-col gap-6">
          ...
          <div className="flex flex-col items-center gap-2 text-center mt-2">
            <div className="w-14 h-14 rounded-none flex items-center justify-center mb-1 bg-primary shadow-[var(--shadow-warm)]">
          ...
          <div className="flex gap-2 w-full">
            {FEATURES.map(({ icon, label, desc }) => (
              <div key={label} className="flex-1 flex flex-col items-center gap-1.5 py-4 px-1 rounded-none border border-border-subtle bg-surface-2">
          ...
          <button
            ...
            className="w-full py-3 flex items-center justify-center gap-2 text-sm font-semibold text-white rounded-none bg-primary hover:bg-primary-hover shadow-[var(--shadow-warm)] active:scale-[0.98] transition-all"
          >
