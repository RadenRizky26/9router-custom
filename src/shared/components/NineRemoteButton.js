  ...
  return (
    <>
      <button
        ...
        className="relative flex items-center gap-1.5 px-2.5 py-1.5 rounded-none transition-all text-text-muted hover:text-text-main hover:bg-black/5 dark:hover:bg-white/5"
        title="9Remote"
      >
