        ...
        {success ? (
          ...
          <>
            <div className="space-y-2">
              ...
              <div className="bg-surface-secondary p-3 rounded-none text-xs space-y-2">
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                className="w-full px-3 py-2 bg-surface-secondary border border-border rounded-none text-sm text-text-primary placeholder-text-muted focus:outline-none focus:ring-2 focus:ring-primary resize-none"
                rows={4}
                disabled={loading}
              />
            </div>
            ...
            {error && (
              <div className="p-3 bg-error/10 border border-error/20 rounded-none">
