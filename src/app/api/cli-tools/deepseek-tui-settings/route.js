...
// Build TOML config for SryRouter (openai provider mode)
const buildSryRouterConfig = (baseUrl, apiKey, model) => {
...
// Detect SryRouter by checking if provider is "openai" and base_url points to localhost/127.0.0.1
...
export async function POST(request) {
    try {
        ...
        const newConfig = buildSryRouterConfig(baseUrl, apiKey || "sk_SryRouter", model);
