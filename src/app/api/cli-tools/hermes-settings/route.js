...
// Detect SryRouter by base_url containing localhost/127.0.0.1 or matching tunnel URL
const hasSryRouterConfig = (modelCfg) => {
...
export async function GET() {
  try {
    ...
    return NextResponse.json({
      installed: true,
      settings: { model },
      hasSryRouter: hasSryRouterConfig(model),
