...
// and break recursive loops between SryRouter instances connected to each other.
...
export async function buildModelsList(kindFilter, options = {}) {
  ...
  // SryRouter instance's fetchCompatibleModelIds — skip dynamic fetch to break
...
export async function GET(request) {
  try {
    // Detect cross-instance recursive /models fetch (another SryRouter fetching our /models)
