...
export default function CodexToolCard({ tool, isExpanded, onToggle, baseUrl, apiKeys, activeProviders, cloudEnabled, initialStatus, tunnelEnabled, tunnelPublicUrl, tailscaleEnabled, tailscaleUrl }) {
  ...
  const handleApplySettings = async () => {
    ...
    setMessage(null);
    try {
      // Use sk_SryRouter for localhost if no key, otherwise use selected key
  ...
  const getManualConfigs = () => {
    ...
    const configContent = `# SryRouter Configuration for Codex CLI
model = "${selectedModel}"
model_provider = "SryRouter"

[model_providers.SryRouter]
name = "SryRouter"
base_url = "${getEffectiveBaseUrl()}"
wire_api = "responses"

[model_providers.SryRouter.http_headers]
