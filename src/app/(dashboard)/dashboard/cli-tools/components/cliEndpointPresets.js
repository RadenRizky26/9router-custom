...
const endpoints = createStore({
  storageKey: "SryRouter.cliToolEndpointPresets",
  changeEvent: "SryRouter:endpoint-presets-changed",
  itemField: "baseUrl",
...
const apiKeys = createStore({
  storageKey: "SryRouter.cliToolApiKeyPresets",
  changeEvent: "SryRouter:api-key-presets-changed",
  itemField: "key",
});
